...
def _map_surge_logic(loader, target: Target, fs_factory, is_zip: bool) -> None:
...
class SurgeLoader(Loader):
    ...
    def map(self, target: Target) -> None:
        ...
        _map_surge_logic(self, target, fs_factory, is_zip=False)
...
class SurgeZipSubLoader(ZipSubLoader):
    ...
    def map(self, target: Target) -> None:
        ...
        _map_surge_logic(self, target, fs_factory, is_zip=True)
